...
public class ScriptConnectionDeletionPatch
{
	...
	public static ScriptConnectionDeletionPatch import(ulong[] mrea_ids, string[] script_types, uint[] layer_indexes, uint[] source_object_ids, string[] states, string[] messages, uint[] target_ids)
	{
		return new ScriptConnectionDeletionPatch
		{
			mrea_ids = mrea_ids,
